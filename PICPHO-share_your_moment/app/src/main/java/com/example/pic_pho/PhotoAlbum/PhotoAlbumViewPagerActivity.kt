...
import com.example.pic_pho.ContentResolverUtil
import com.example.pic_pho.Lobby.DBHelper
import com.example.pic_pho.databinding.ActivityPhotoAlbumViewPagerBinding
            ...
            for (i in 0 until absolutePathIndexArray.length()) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    if (contentResolverUtil!!.isExist(uri)) {
                        ...
                        Log.e("TAG", "onCreate: ViewPagerActivity!!!!!!!!!!!!!!!!: 파일이 있습니다")
                    } else {
                        Log.e("TAG", "onCreate: ViewPagerActivity!!!!!!!!!!!!!!!!: 파일이 없습니다")
                        // todo : 파일이 없을 때, 리스트에서도 지워줘야할 것 같습니다..
                    }
                }
            }
