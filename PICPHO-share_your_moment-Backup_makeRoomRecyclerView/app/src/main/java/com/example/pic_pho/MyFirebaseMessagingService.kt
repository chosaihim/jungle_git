...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        if(remoteMessage.data.isNotEmpty()){
            ...
            Log.i("방번호: ", remoteMessage.data["room"].toString())
            sendNotification(remoteMessage,  remoteMessage.data["room"].toString())
        }
    ...
    // 핸드폰에 알림 메시지 표시
    private fun sendNotification(remoteMessage: RemoteMessage, RoomAddress:String) {
